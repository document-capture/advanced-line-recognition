tableextension 70001 "ALR Template" extends "CDC Template"
{
    fields
    {
        field(70000; "ALR Line Validation Type"; Option)
        {
        ...
        field(70001; "Auto PO search"; Boolean)
        {
            Caption = 'Automatic PO search';
            DataClassification = CustomerContent;
        }
        field(70002; "Auto PO search filter"; Text[200])
        {
