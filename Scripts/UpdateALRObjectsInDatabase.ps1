param([string]$ServerName, [string]$DatabaseName, [string]$TempDirectory, [string]$DeltaPath)

#Create directory for temporary files
$OriginalPath = $(Join-Path $TempDirectory "ORIGINAL")
$ResultPath = $(Join-Path $TempDirectory "RESULT")
